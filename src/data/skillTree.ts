...
export const SKILL_NODES: SkillNodeDef[] = [
  ...
  },
  {
    id: 'N17',
    name: 'デリミタTextObj',
    commands: ['i"', 'a"', "i'", "a'", 'i(', 'a(', 'i{', 'a{', 'i[', 'a[', 'i<', 'a<'],
    stageCount: 2,
    prerequisites: ['N16'],
  },
  {
  ...
  { id: 'N20', name: 'インデント', commands: ['>>', '<<'], stageCount: 1, prerequisites: ['N18'] },
  {
    id: 'N21',
    name: 'Visualモード',
