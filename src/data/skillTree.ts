...
export const SKILL_NODES: SkillNodeDef[] = [
    ...
    { id: 'N04', name: '行頭/末Insert', commands: ['I', 'A'], stageCount: 1, prerequisites: ['N01'] },
    { id: 'N05', name: '新行Insert', commands: ['o', 'O'], stageCount: 1, prerequisites: ['N04'] },
    { id: 'N06', name: '1文字置換', commands: ['r'], stageCount: 1, prerequisites: ['N01'] },
    { id: 'N07', name: '大小切替', commands: ['~'], stageCount: 1, prerequisites: ['N01'] },
    { id: 'N09', name: 'WORD移動', commands: ['W', 'B', 'E'], stageCount: 1, prerequisites: ['N01'] },
    { id: 'N10', name: '行頭/末移動', commands: ['0', '$'], stageCount: 1, prerequisites: ['N01'] },
    ...
    { id: 'N23', name: '行内ジャンプ', commands: ['f', 't'], stageCount: 2, prerequisites: ['N10'] },
