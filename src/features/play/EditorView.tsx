...
export function EditorView({ state, goalText, goalCursor, goalViewportTop, showGoal, language }: EditorViewProps) {
    ...
    const vpTop = useViewport
        ? (showGoal && goalViewportTop !== undefined ? goalViewportTop : state.viewportTop)
        : 0
                ...
                <div className="editor-goal">
                    ...
                    <div className="goal-text" ref={goalTextRef}>
                        {(() => {
                            ...
                            const useGoalVp = goalViewportTop !== undefined && allGoalLines.length > VIEWPORT_HEIGHT
                            const gVpTop = useGoalVp ? goalViewportTop! : 0
                            const gVpEnd = useGoalVp ? Math.min(gVpTop + VIEWPORT_HEIGHT, allGoalLines.length) : allGoalLines.length
                            ...
                            return (
                                <>
                                    ...
                                    {useGoalVp && gVpEnd < allGoalLines.length && (
                                        <div className="viewport-indicator bottom">↓ {allGoalLines.length - gVpEnd} lines below</div>
                                    )}
                                </>
                            )
                        })()}
